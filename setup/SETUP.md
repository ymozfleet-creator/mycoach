...
手数料は両建てモデル：受講者はレッスン料+システム利用料10%を支払い、
コーチはレッスン料から事務手数料20%を控除した額を受け取ります
（例：レッスン料¥5,000 → 受講者支払 ¥5,500 / コーチ受取 ¥4,000 / 運営収益 ¥1,500）。
...
「受講者 → Stripe →（受講者10%＋コーチ20%を運営へ / 残額をコーチへ）」と自動分配されます。
